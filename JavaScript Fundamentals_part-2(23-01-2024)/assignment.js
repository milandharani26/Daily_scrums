...
const descIndia = describeCountry('india', 10,
    'Delhi');
const descUsa = describeCountry('usa', 83,
    'eashington');
const descMaldives = describeCountry('maldives', 6,
    'modiji');
console.log(descIndia, descUsa, descMaldives);
...
const descIndia1 = percentageOfWorld1(10);
const descUsa1 = percentageOfWorld1(1441);
const descMaldives1 = percentageOfWorld1(332);
console.log(descIndia1, descUsa1, descMaldives1);
